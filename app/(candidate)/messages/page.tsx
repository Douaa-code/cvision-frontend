...
import { mockConversations, type Conversation } from "@/lib/mock-data/messages";
      ...
      <div className="flex flex-1 border border-border rounded-xl overflow-hidden bg-white min-h-0">
              ...
              return (
                ...
                >
                  ...
                  <div className="min-w-0">
                    <p className="font-semibold text-sm truncate">{conv.companyName}</p>
        ...
        <div className="flex flex-col flex-1 min-w-0">
          ...
          <div className="flex items-center gap-3 px-6 py-4 border-b border-border shrink-0">
            ...
            <div>
              <p className="font-semibold text-sm">{selected.companyName}</p>
