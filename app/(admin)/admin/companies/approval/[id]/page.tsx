  ...
  if (!company) {
    return (
      <div className="text-center py-12">
        ...
        <Link href="/admin/companies"><Button variant="outline" className="mt-4">Back</Button></Link>
      </div>
    );
  }
        ...
        <Card>
          <CardContent className="p-8 text-center">
            ...
            <p className="text-muted-foreground mb-6">
              {company.companyName} has been {resultAction}. {resultAction === "approved" ? "They can now post job offers." : "They have been notified."}
            </p>
              ...
              <div className="space-y-3">
                <div className="p-4 border border-border rounded-lg">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Uploaded on {company.documents.commercialRegister.uploadedAt.toLocaleDateString()}
                  </p>
                </div>
                <div className="p-4 border border-border rounded-lg">
                  <div className="flex items-center justify-between mb-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Uploaded on {company.documents.nifDocument.uploadedAt.toLocaleDateString()}
                  </p>
                </div>
              </div>
            </CardContent>
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold">
                    {Math.ceil((Date.now() - company.registrationDate.getTime()) / (1000 * 60 * 60 * 24))} days
                  </span>
                </div>
              </div>
            </CardContent>
      ...
      <Dialog open={!!decision} onOpenChange={() => setDecision(null)}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              {decision === "approve"
                ? "The company will be able to create job offers and recruit candidates."
                : "The company will be notified and will not be able to use the platform."}
            </DialogDescription>
          </DialogHeader>
          <Textarea
            value={comment}
